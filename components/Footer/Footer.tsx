        ...
        <div className={styles.top}>
          ...
          <div className={styles.brand}>
            ...
            <div className={styles.socialRow}>
              ...
              <a
                href="https://tiktok.com/@sangriavictoria"
                target="_blank"
                rel="noopener noreferrer"
                className={styles.socialLink}
                aria-label="TikTok de Sangría Victoria"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
          ...
          <div>
            ...
            <ul className={styles.linkList}>
              <li><Link href="/ventas?cat=Clasica" className={styles.navLink}>Victoria Clásica</Link></li>
              <li><Link href="/ventas?cat=Tropical" className={styles.navLink}>Victoria Tropical</Link></li>
              <li><Link href="/ventas?cat=Rose" className={styles.navLink}>Victoria Rosé</Link></li>
